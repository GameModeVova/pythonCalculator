...
# 2) Max decimal fractions before truncation == 10 (if number has only 1 
# 3) Max numbers can be displayied on the calc is 11 
# (so if the number is too big and wont fit (this could happen only if there will be too much 
# decimal fractions), its decimal part will be cutted)
